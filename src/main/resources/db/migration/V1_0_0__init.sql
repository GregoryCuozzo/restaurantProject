...
alter table villes add constraint FK_pays foreign key (pays) references pays(id_pays);
...
alter table restaurants add constraint FK_ville foreign key (ville) references villes(id_ville)
